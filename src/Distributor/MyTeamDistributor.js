        ...
        try {
            await fetch("https://kwikm.in/dev_kwikm/api/my_downline.php", {
                ...
                .then(myRetailerListData => {
                    // console.log(myCorporateListData)
                                ...
                                {myRetailerList.length > 0 ?
                                                        ...
                                                        onPress={
                                                            () =>
                                                                navigation.navigate("earningDetailsDistributor",
                                                                    { retailer_id, retailer_name, retailer_balance, logo })}
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ height: responsiveHeight(5) }}>
                                            <Text style={{ color: "black", fontSize: responsiveFontSize(2.2), fontWeight: "700" }}>No Retailer Found. . .</Text>
                                        </View>
                                    </View>

...
const AddDistributor = () => {
    ...
    const CorporateValidation = () => {
        if (full_name.length >= 2 && mobile_nun.length == 10 && mpin.length == 4 && email.length >= 11) {
                ...
                <>
                    ...
                    <View style={{ height: responsiveHeight(8), flexDirection: "row" }}>
                        ...
                        <View style={{ flex: 5, justifyContent: "space-between", alignItems: "center", flexDirection: "row" }}>
                            <View>
                                <Text style={{ fontSize: responsiveFontSize(2.5), color: "black", fontWeight: "700" }}>Add Distributor</Text>
                            </View>
                        </View>
                    </View>
                            ...
                            <>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity
                                        ...
                                        <Text style={{ fontSize: responsiveFontSize(2), color: "white", fontWeight: "700" }}>Go Back</Text>
                                    </TouchableOpacity>
                                </View>
                            </>
                            :
                                ...
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                            <Font5 name="user-alt" size={responsiveWidth(5.2)} color="#535353" />
                                        </View>
                                        <View style={{ flex: 5 }}>
                                            <TextInput
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                            <Font name="envelope" size={responsiveWidth(5.5)} color="#535353" />
                                        </View>
                                        <View style={{ flex: 5 }}>
                                            <TextInput
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                            <Font5 name="lock" size={responsiveWidth(5.5)} color="#535353" />
                                        </View>
                                        <View style={{ flex: 5 }}>
                                            <TextInput

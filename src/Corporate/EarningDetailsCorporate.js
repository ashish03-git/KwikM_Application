                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ flex: 1.2, justifyContent: "center", alignItems: "center" }}>
                                            {distributor_logo.length > 1 ?
                                                <Image source={{ uri: distributor_logo }}
                                        ...
                                        <View style={{ flex: 3, justifyContent: "center" }}>
                                            <Text style={{ fontSize: responsiveFontSize(1.8), color: "black", fontWeight: "700" }}>{distributor_name}</Text>
                                            <Text style={{ fontSize: responsiveFontSize(1.7), color: "black", fontWeight: "400" }}>ID: {distributor_id}</Text>
                                        </View>
                                        <View style={{ flex: 1.2, justifyContent: "center", alignItems: "center" }}>
                                            ...
                                            <View style={{ flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                                                ...
                                                <Text style={{ fontSize: responsiveFontSize(1.7), color: "#0D950A", fontWeight: "700" }}> {distributor_balance}.00</Text>
                                            </View>
                                        </View>
                                    </View>
                                </View>
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ height: responsiveHeight(3) }}>
                                                <Text style={{
                                                    ...
                                                    fontWeight: "700"
                                                }}>No Transaction Found For This Distributor . . .</Text>
                                            </View>
                                        </View>

...
const MyLeadRetailer = () => {
  ...
  const FetchRetailerAllLead = async () => {` `
    try {
      ...
      // console.log(ob)
      let response = await fetch("https://kwikm.in/dev_kwikm/api/my_leads.php", {
        method: "POST",
        headers: {
            ...
            >
              ...
              <View style={{ height: responsiveHeight(8), flexDirection: "row" }}>
                ...
                <View style={{ flex: 5, justifyContent: "space-between", alignItems: "center", flexDirection: "row" }}>
                  <View>
                    <Text style={{ fontSize: responsiveFontSize(2.5), color: "black", fontWeight: "700" }}>My Lead</Text>
                  </View>
                </View>
              </View>
                ...
                {myLeadList.length > 0 ?
                  <View>
                    <FlatList
                      ...
                      renderItem={({ item }) => {
                        const logo = item.full_name[0] ? item.full_name[0].toUpperCase() : null
                          ...
                          <View style={{
                            ...
                            <View style={{ flex: 2, flexDirection: "row" }}>
                              <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                ...
                                >
                                  <Text style={{ fontSize: responsiveFontSize(4.5), color: "white", fontWeight: "700" }}>{logo}</Text>
                                </View>
                              </View>
                              <View style={{ flex: 4, flexDirection: "row" }}>
                                <View style={{ flex: 3, justifyContent: "center" }}>
                                  <Text style={{ color: "black", fontWeight: "700", fontSize: responsiveFontSize(1.7) }}>{item.full_name}</Text>
                                  ...
                                  <Text style={{ color: 'black', fontSize: responsiveFontSize(1.6) }}>+91 {item.mobile_no}</Text>
                                </View>
                  ...
                  <View style={{
                    ...
                    <View style={{ height: responsiveHeight(5) }}>
                      <Text style={{ color: "black", fontSize: responsiveFontSize(2.2), fontWeight: "700" }}>No Lead Found. . .</Text>
                    </View>
                  </View>

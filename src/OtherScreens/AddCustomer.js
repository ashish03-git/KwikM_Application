...
const AddCustomer = () => {
    ...
    const VerifyDetails = async () => {
        ...
        const baseUrl = 'https://tryleadapi.banksathi.com/api/b2b/checkCustomerExists';
        const params = {
                        ...
                        {screenName === "paytm" ?
                                ...
                                <View style={{ flex: 1, justifyContent: "center" }}>
                                    <View style={{ margin: responsiveWidth(4), marginTop: 0 }}>
                                        <Text style={{ fontSize: responsiveFontSize(1.8), color: "black" }}>
                                            ...
                                            <Text style={{ fontSize: responsiveFontSize(1.8), color: "#9B19A6", fontWeight: "600" }}> Terms & Conditions </Text>
                                            and
                                            <Text style={{ fontSize: responsiveFontSize(1.8), color: "#9B19A6", fontWeight: "600" }}> Privacy Policy</Text>
                                        </Text>
                                    </View>
                                    <View style={{ margin: responsiveWidth(4), marginTop: responsiveWidth(0) }}>
                                        <TouchableOpacity
                            ...
                            <>
                                <View style={{
                                    ...
                                    {leadGenerationStatus ?
                                        <View style={{ marginBottom: responsiveWidth(4), marginTop: responsiveWidth(4) }}>
                                            <Text style={{ fontSize: responsiveFontSize(2), color: "green", alignSelf: "center" }}>{msg}</Text>
                                        </View>
                                        :
                                        <View style={{ marginBottom: responsiveWidth(4), marginTop: responsiveWidth(4) }}>
                                    ...
                                    <View style={{ margin: responsiveWidth(4), marginTop: responsiveWidth(4) }}>
                                        {buttonStatus ?
                                            <TouchableOpacity

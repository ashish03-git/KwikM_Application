...
const ProductDetails = () => {
    ...
    // console.log("product direct details",productId)
                        ...
                        <View style={{ flex: 1, backgroundColor: "#EAFFEA" }}>
                            ...
                            <View style={{ height: responsiveHeight(8), flexDirection: "row" }}>
                                ...
                                <View style={{ flex: 4, justifyContent: "space-between", alignItems: "center", flexDirection: "row" }}>
                                    <View>
                                        <Text style={{ fontSize: responsiveFontSize(2.5), color: "black", fontWeight: "700" }}>Products Details</Text>
                                    </View>
                                </View>
                            </View>
                                ...
                                >
                                    <View style={{ flex: 1, justifyContent: "center", paddingLeft: responsiveWidth(3) }}>
                                        <Image source={{ uri: logo }}
                                            style={{
                                                borderRadius: responsiveWidth(3),
                                                width: responsiveWidth(21), height: responsiveHeight(8),
                                                resizeMode: "cover"
                                            }} />
                                    </View>
                                    <View style={{ flex: 2, justifyContent: "center" }}>
                                        <Text style={{ fontSize: responsiveFontSize(2.2), color: 'white' }}>{title}</Text>
                                    </View>
                                </LinearGradient>
                            </View>

                            <View style={{ flexDirection: "row", justifyContent: "space-evenly", alignItems: "center", height: responsiveHeight(8), padding: responsiveWidth(5) }}>
                                <TouchableOpacity
                                    onPress={() => {
                                        setStats(true)
                                        setDetails(false)
                            ...
                            <View>
                                {stats ? <MyStats data={[commission,productId,categoriID]} /> : null}

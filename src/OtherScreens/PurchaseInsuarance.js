...
const PurchaseInsuarance = () => {
    ...
    const getUserDetails = async () => {
        await AsyncStorage.getItem("user_id").then(id => setUser_id(JSON.parse(id)))
        await AsyncStorage.getItem("auth_token").then(token => setAuth_token(JSON.parse(token)))
    }

    const CheckValue = async () => {
        if (full_name.length >= 2 && mobile_nun.length == 10 && email.length >= 11 && state.length >= 2 && address.length >= 3) {
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                                <Font5 name="user-alt" size={responsiveWidth(5.2)} color="#686868" />
                                            </View>
                                            <View style={{ flex: 5 }}>
                                                <TextInput
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                                <Font5 name="phone-alt" size={responsiveWidth(5.5)} color="#686868" />
                                            </View>
                                            <View style={{ flex: 5 }}>
                                                <TextInput
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                                <Font name="envelope" size={responsiveWidth(5.5)} color="#686868" />
                                            </View>
                                            <View style={{ flex: 5 }}>
                                                <TextInput
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                                <Font6 name="location-dot" size={responsiveWidth(5.5)} color="#686868" />
                                            </View>
                                            <View style={{ flex: 5 }}>
                                                <TextInput
                                        ...
                                        <View style={{
                                            ...
                                            <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                                                <Font6 name="map-location-dot" size={responsiveWidth(5.5)} color="#686868" />
                                            </View>
                                            <View style={{ flex: 5 }}>
                                                <TextInput
                                    ...
                                    <View style={{
                                        ...
                                        {buttonStatus ?
                                            <TouchableOpacity
                                                ...
                                                <Text style={{ fontSize: responsiveFontSize(2), color: "white", fontWeight: "700" }}>Continue</Text>
                                            </TouchableOpacity>
                                            :
                                            <TouchableOpacity
                                                disabled
                                        ...
                                        <View style={{ marginTop: responsiveWidth(3), justifyContent: "center", alignItems: "center", flexDirection: "row" }}>

    ...
    return (
        ...
        <>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                {activityIndicator ?
                    <View style={{ width: responsiveWidth(100), height: responsiveHeight(75) }}>
                        <ActivityLoader />
                    </View>
                    :
                    <View style={{
                        width: responsiveWidth(100),
                        height: leadList.length > 0 ? responsiveHeight(80) : responsiveHeight(50),
                        justifyContent: "center",
                        alignItems: "center",
                    }}>
                        {leadList.length > 0 ?
                            <>
                                ...
                                />
                                <TouchableOpacity
                                    onPress={() => navigation.navigate('addcustomer', { screenName: "product" })}
                                    style={{

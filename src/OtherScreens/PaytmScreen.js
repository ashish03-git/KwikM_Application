                            ...
                            <View style={{ flex: 1, backgroundColor: "#EAFFEA" }}>
                                ...
                                <View style={{ height: responsiveHeight(8), flexDirection: "row" }}>
                                    ...
                                    <View style={{ flex: 4, justifyContent: "space-between", alignItems: "center", flexDirection: "row" }}>
                                        <View>
                                            <Text style={{ fontSize: responsiveFontSize(2.5), color: "black", fontWeight: "700" }}> Paytm</Text>
                                        </View>
                                    </View>
                                </View>
                                ...
                                <View style={{ justifyContent: "center", alignItems: "center" }}>
                                    ...
                                    >
                                        ...
                                        <View style={{ flex: 2, justifyContent: "center" }}>
                                            <Text style={{ fontSize: responsiveFontSize(2.2), color: 'white' }}>Paytm UPI Registration</Text>
                                        </View>
                                    </LinearGradient>
                                </View>
                                ...
                                {paySprintLeadLists ?
                                    <View style={{ height: responsiveHeight(84), alignItems: "center" }}>
                                        <FlatList
                                                        ...
                                                        <View style={{ flex: 2, flexDirection: "row" }}>
                                                            ...
                                                            <View style={{ flex: 4, flexDirection: "row" }}>
                                                                <View style={{ flex: 3, justifyContent: "center" }}>
                                                                    ...
                                                                    <Text style={{ color: 'black', fontSize: responsiveFontSize(1.7) }}>+91 {item.customer_mobile}</Text>
                                                                </View>
                                        ...
                                        />
                                        <TouchableOpacity
                                            onPress={() => naviagtion.navigate("addcustomer", { screenName })}
                                            style={{
